#Assignment 3 - Classification - parameter plots
...
plt.title('F1 score vs scale_pos_weight  (GBM)')
plt.plot(range(1,11),scores1[0,:75], label = ' Training Data')
plt.plot(range(1,11),scores1[1,:75], label = ' Test Data')
...
plt.figure()
plt.title('Recall score vs scale_pos_weight  (GBM)')
plt.plot(range(1,11),scores1[0,:75], label = ' Training Data')
plt.plot(range(1,11),scores1[1,:75], label = ' Test Data')
plt.xlabel('scale_pos_weight ')
